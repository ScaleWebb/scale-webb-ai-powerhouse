...
const digitalProducts = [
  { icon: Cloud, name: "ERP cloud verticale per manifattura" },
  { icon: Cpu, name: "Moduli MES per produzione e shopfloor" },
...
const ProductsSection = () => (
  <section id="prodotti" className="section-padding bg-card/50">
      ...
      <div className="grid lg:grid-cols-2 gap-10">
        ...
        <AnimatedSection delay={0.1}>
          <div className="bg-card border border-border rounded-xl p-8 h-full">
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Scale Webb acquisisce e sviluppa SaaS, app e infrastrutture AI con focus B2B e manifatturiero.
            </p>
        ...
        <AnimatedSection delay={0.2}>
          <div className="bg-card border border-border rounded-xl p-8 h-full">
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Scale Webb acquisisce PMI manifatturiere italiane ed europee in settori come automotive,
              machinery, automation, chemicals e textiles.
            </p>
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Obiettivo: migliorare EBITDA da ~6% a 14% con interventi digitali e operativi.
            </p>
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                { label: "Costi operativi", value: "-20/30%" },
                { label: "Inventory", value: "-20/35%" },
                { label: "Logistica", value: "-15%" },
              ].map((m) => (
